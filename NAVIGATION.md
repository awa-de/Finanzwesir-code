...
| `/kassensturz` | Wöchentlicher Trend-Check (Backlog-Entwicklung, Blocker, Tendenz) | Montags automatisch in `/start` (vor Warm-Start/Kettenmodus/Vollmodus-Verzweigung); oder manuell |
...
> AP-tailwind-02a–02b ✅ 2026-07-13 — Play-CDN-Vertrag repo-weit festgelegt, synchronisiert und gehärtet (Nachlaufarbeit zu AP-tailwind-01, keine UI-Migration). AP-tailwind-02a (GRÜN): Tailwind v4 Play-CDN (`https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4`) als Phasentrennung (vorproduktive Testphase = CDN, Produktion = lokaler Build T1) in `01_DECISION_LOG.md` A-04, `TAILWIND-APP-BAUKASTEN_KONZEPT_V0-1.md`, `TEST_PAGE_STANDARD.md` §10/§12/§14, App-Testseiten-Template, `Apps/prokrastinations-preis/app.test.html`, Checker (`tools/check-test-pages.py`, neue `validate_tailwind_cdn()`), Pilotprompt (Slice-0-Laufzeitfrage entfernt) verankert; VISUAL-BOARD/MOCKUPS von v3-CDN+`tailwind.config` auf v4-CDN+`@theme`-Syntax umgestellt (technisch notwendig, sonst ungestylt); `fw-app-template.html` bewusst nicht angefasst (verbotene Alt-Namen `-80/-20/-30/-tint`). AP-tailwind-02b (GRÜN, Nachputz): Checker auf bytegenauen URL-Vergleich gehärtet (Query/Fragment brechen die Kanonizität, `type="module"` case-insensitiv gesperrt), Trailing-Whitespace in `01_DECISION_LOG.md` entfernt (`git diff --check` grün), veraltete „Slice 0 = Tailwind-Laufzeitfrage"-Klausel in `BACKLOG.md` read-frei über `replace-matched-line.py` korrigiert (Hook-Parser-Vertrag vorher geprüft: Zeile lag außerhalb des vom Hook gelesenen 🟡-Aktiv-Abschnitts, keine Regression). 20/20 Crashtests + realer Checker (16 Testseiten, 0 Fehler) beide Male grün. Ergebnisprotokoll: `docs/steering/patches/AP-tailwind-02a_play-cdn-vertrag-repo-sync_Ergebnis.md` (inkl. Nachtrag AP-tailwind-02b). Nächster Schritt: AP-tailwind-02 Slice 1 — Shell/States (erster echter Migrations-Slice, Gate → Alberts OK → Patch → Live-Server-Test).
AP-tailwind-02 Slices 1–8 + AP-tailwind-02f ✅ 2026-07-13 — Pilotmigration `prokrastinations-preis` auf den Tailwind-Baukasten vollständig umgesetzt und browserabgenommen. Slice 1 Shell/States, Slice 2 KPI, Slice 3 Slider-Field, Slice 4 Buttons/CTA (inkl. eigenständigem Manifest-Fix: `makeBtn()` von CSS-String-Parameter auf Rezeptschlüssel umgestellt, Play-CDN-Checker-Invariante von Laufzeit-Datenfluss auf deklarierte `FW_*_CLASS`-Konstanten umgestellt), Slice 5 Stationen-Panel, Slice 6 Disclosure/Callout/sr-only, AP-tailwind-02f (Q-08 responsiver Disclosure-Kontrakt), Slice 7 Chart-Slot (D-04 Ein-Container-Vertrag), Slice 8 Screen-Rahmen/Headline/Navigation. Checker (`tools/check-test-pages.py`) über alle Slices durchgehend grün, `tools/ci-token-check.js` von 5 auf 10 eigenständige Werkzeuge erweitert (fwButtonCtaCheck, fwStationPanelCheck, fwDisclosureCalloutCheck, fwChartSlotCheck, fwScreenFlowCheck). Read-only CSS-Inventur vor Slice 8 identifizierte den letzten offenen Rest: `.fw-app__screen-subline` trägt sowohl normale Screen-Sublines als auch geschützten Rubikon-Fließtext unter derselben Klasse — Rubikon-Subline-Konflikt bleibt offen, eigener Folge-AP, Albert-Entscheidung aussteht. Ergebnisprotokolle: `docs/steering/patches/AP-tailwind-02_slice-3_slider_Ergebnis.md` bis `..._slice-8_screen-flow-nachputz_Ergebnis.md`, `AP-tailwind-02f_disclosure-responsive-kontrakt-sync_Ergebnis.md`. Nächster Schritt: Alberts Entscheidung zum Rubikon-Subline-Konflikt.
> AP-chart-engine-01 (CE-1–CE-3b) + AP-chart-engine-tool-01 ✅ 2026-07-14 — Erster Strang des gestaffelten Engine-DOM-Chrome-Programms (Hauptübergabe: Archiv/local/muss noch eingeordnet werden/claude_prompt_AP-chart-engine-01_hauptuebergabe-gestaffelte-entwicklung.md, Ziel CE-1→CE-6). CE-1/CE-1a (Read-only-Inventur): Engine-Chrome entsteht ausschließlich in FwRenderer.js; Findings F-05 (veraltete TECH-SPEC Theme-Integration) und F-06 (Pie-Popover an document.body, Schranke vor CE-5) dokumentiert. CE-2 gestoppt (F-07: Tailwind-Utilities auf den absichtlich Tailwind-freien dauerhaften Engine-Testseiten nicht generierbar); CE-2b umgesetzt: FwRenderer behält einen schmalen, tokenbasierten CSS-Kompatibilitätsboden neben den Tailwind-Literalrezepten (§6.9–6.11), Error-Fallback nach Korrektur CI-konform (§6.10-Tokens). Neues Diagnosewerkzeug tools/engine-dom-check.js (AP-chart-engine-tool-01: Positiv- UND Negativfall real im Browser verifiziert). CE-3/CE-3a/CE-3b (Line-Chart-Chrome): Titel/BAN/Toolbar/Segmented-Controls/Legende für type==='line' auf Baukasten-Literale migriert (§6.5/§6.11, echte button role=group aria-pressed-Pills/-Controls), Bar/Donut/Pie nachweislich unverändert; zwei reale Nacharbeiten aus Alberts Browser-Abnahme (CE-3a: BAN self-start/View-Rechtsanker/Zone-S/Pill-Kontur; CE-3b: Wrapper-gap-Fallback + Kaskaden-Reihenfolge-Korrektur — Lehre: bei gleicher Selektorspezifität entscheidet die Quellreihenfolge, nicht Intuition). CE-3b von Albert browserabgenommen. Ergebnisprotokolle: docs/steering/patches/AP-chart-engine-01_CE-2b_*_Ergebnis.md, ..._CE-2c_*, AP-chart-engine-tool-01_*, AP-chart-engine-01_CE-3_*, ..._CE-3a_*, ..._CE-3b_*. Nächster Schritt: CE-4 Bar-Chart-Chrome (Prompt liegt vor, noch nicht begonnen); CE-1–CE-3b + Tool-AP committed (20bb90c, 2026-07-14).
> AP-chart-engine-01 DOC-01 ✅ 2026-07-14 — Line-Chart-Chrome-Vertragsnachzug: Baukasten-Konzept (D-02 funktionale Legend-Pill-Kontur, §5.3-Zuordnungstabelle, §6.11 finales Pill-/BAN-/Toolbar-/Wrapper-Rezept inkl. App-Fabrik-Verbindlichkeitsklausel), Mockup „Depotverlauf mit und ohne Warten" (echte aria-pressed-Buttons, zweite Control-Gruppe, Zone-S-Dokumentationsnotiz) und Test-Page-Standard (§10 Engine-Fallback-Paritätspflicht, §5.3 Chart-Chrome-Beispiel) auf den von Albert browserabgenommenen CE-3b-Ist-Stand nachgezogen — reine Dokumentation, kein Produktcode. Ergebnisprotokoll: docs/steering/patches/AP-chart-engine-01_DOC-01_line-chart-chrome-vertragsnachzug_Ergebnis.md. CE-1–CE-3b + Tool-01 sind bereits committed (20bb90c, 2026-07-14). Nächster Schritt: CE-4 Bar-Chart-Chrome; DOC-01 committed (9dd899d, 2026-07-14).
> AP-chart-engine-01 (CE-4/CE-4c) ✅ 2026-07-15 — Zweiter Strang des gestaffelten Engine-DOM-Chrome-Programms. CE-4 (Bar-Chart-Chrome): Wrapper/Titel/Toolbar/Segmented-Controls/reguläre Mehrserien-Legende für type==='bar' auf Baukasten-Literale migriert (§6.5/§6.11), Ranking-Bar/Donut/Pie nachweislich unverändert (Ranking-Schranke: `interactiveFilters` bleibt hartcodiert `false` in `BarChartStrategy._transformAssetView()`). CE-4c (Reparatur-AP): behebt eine in CE-4 entstandene Architekturabweichung — elf `FW_BAR_*`-Vollrezepte waren inhaltlich identisch mit den bereits vorhandenen `FW_LINE_*`-Rezepten, Verstoß gegen den CE-4a-Nachtrag ("identische Chrome-Rezepte existieren genau einmal"). Konsolidiert auf elf gemeinsame `FW_CHROME_*`-Konstanten (Wrapper/Titel/Toolbar/Segmented-Gruppe/-Option/View-Gruppe/Legendengruppe/Pill/Dot); Typmarker (`fw-chart-wrapper--line`/`--bar`) + gemeinsamer Chrome-Anker (`fw-chart-chrome`) nur noch per `classList.add()` (keine Stringverkettung), Line-BAN bleibt line-exklusiv unverändert. `tools/engine-dom-check.js` um additiven Chrome-Kern-Prüfblock erweitert (Typmarker+Anker, echte `<button aria-pressed>` bei Controls/Legend-Pills). Alle drei Charttypen (Line/Bar/Donut) real im Browser abgenommen (Sicht + Struktur-Tool, 3 Testseiten: line-ci/bar-ci/pie-ci.test.html). Ergebnisprotokolle: docs/steering/patches/AP-chart-engine-01_CE-4_bar-chart-chrome_Ergebnis.md, ..._CE-4c_gemeinsamer-chrome-kern_rezeptzentralisierung_Ergebnis.md, PATCH-engine-dom-check-chrome-kern-erweiterung-2026-07-15.md. Nächster Schritt: CE-5 Donut/Pie-Chart-Chrome (Prompt liegt vor, noch nicht begonnen); CE-4/CE-4c noch nicht committed.
> AP-chart-engine-01 DOC-02/DOC-02a ✅ 2026-07-15 — Semantischer Chrome-Auftrag und Erweiterungsvertrag: neue KDR 15 in ARCHITECTURE STRATEGY PAPER VX.md (Strategie liefert Was, Renderer baut Wie, Manager haelt dynamischen State, technische Durchleitung ausdruecklich noch nicht implementiert), neuer Abschnitt 2.6 in „Der Rucksack" (Chrome-Auftrag als eigenstaendiges Pattern, kein fwContext-Feld), neuer Erweiterungsvertrag in Baukasten §6.11 (geschlossene Bedarfsliste, vier Verbote, Erweiterungsregel fuer kuenftige Charttypen). DOC-02a behebt einen von Albert gefundenen Widerspruch: §10-Tabelle nahm die noch offene Donut-Legendenbedeutung vorweg — korrigiert auf neutralen Ist-Stand. Reine Dokumentation, kein Code. Ergebnisprotokolle: docs/steering/patches/AP-chart-engine-01_DOC-02_semantischer-chrome-auftrag-und-erweiterungsvertrag_Ergebnis.md, ..._DOC-02a_baukasten-paragraph10-konsistenznachtrag_Ergebnis.md. Nächster Schritt: CE-5-Preflight; committed (6470c71, 2026-07-15).
> AP-chart-engine-01 CE-5-Preflight bis CE-5d + DOC-03/DOC-04/DOC-04a ✅ 2026-07-15 — Donut/Pie-Chart-Chrome mit Segment-Daempfung, dritter Strang des gestaffelten Engine-DOM-Chrome-Programms. CE-5-Preflight (read-only Ist-/Soll-Vertragskarte): Titel/Range-/View-Control/BAN/Caption eindeutig, einzig die Legende offen (Ist-Code interagiert real per Segment-Ghosting, passt zu keiner der drei bereits belegten Baukasten-Bedeutungen) — Status GELB, Albert-Entscheidung noetig. DOC-03: Albert entscheidet die vierte Legendenbedeutung „Segment-Daempfung umschalten" fuer Donut/Pie, Baukasten §6.11/§10 ergaenzt. CE-5 (Umsetzung): erster Anlauf stoppte korrekt mit ROT (eigene Commit-Vorbedingung nicht erfuellt, kein Teil-Write), nach Alberts Commit real umgesetzt — Pie-Legendeneintraege werden echte Button-Elemente mit aria-pressed, Zustand aus PieChartStrategy._status gelesen (keine zweite Quelle); bewusst KEINE neue Tailwind-Rezeptur fuer die Legendenoptik (Baukasten-Zwei-Schatten-Stufen-Regel D-09 liess sich nicht verlustfrei mit dem Ist-Schatten/Hover-Lift vereinbaren) — bestehende CSS-Klasse unveraendert weiterverwendet. Neues Werkzeug tools/pie-segment-damping-interaction-check.js (Klick-Rundreise, bewusst getrennt von engine-dom-check.js gebaut, um dessen Read-only-Vertrag nicht zu verletzen); engine-dom-check.js um read-only Segment-Daempfungs-Struktur-Block erweitert. CE-5a/CE-5b/CE-5c (Fokusring-Iteration): CE-5a fuehrte eigenen Pie-Fokusring mit ring-offset-2 und falscher Petrol-Stufe ein; CE-5b korrigierte auf Petrol-500 (c.petrol80); CE-5c konsolidierte auf einen gemeinsamen focus-visible-Fallback fuer Segmented-Option/Legend-Pill/Pie-Segment-Daempfung ohne Offset (spezifischerer Chart-Primitive-Vertrag schlaegt den allgemeinen Button-Vertrag §6.4). DOC-04: Albert entscheidet, dass alle Legend-Pills kuenftig dieselbe Ruhe-/Hover-/Fokus-Basisoptik teilen (hebt den bisherigen Schutz der Pie-Altoptik gezielt auf); Baukasten + Visual Board praezisiert. DOC-04a: Ghost-Zustands-Visualreferenz im Visual Board ergaenzt. CE-5d (Umsetzung der DOC-04-Entscheidung): aktive Pie-Pill nutzt jetzt direkt FW_CHROME_LEGEND_PILL_CLASS/FW_CHROME_LEGEND_DOT_CLASS (keine Kopie), gemeinsame Chrome-Fallback-Regeln um den Pie-Anker erweitert (Ghost-Zustand per :not(.hidden-dataset):hover explizit geschuetzt). Alle Schritte real im Browser bestaetigt: Sichtpruefung optisch einwandfrei (Line/Bar/Pie, Fokus S/M/L), engine-dom-check.js 9/9 PASS auf allen drei Testseiten, pie-segment-damping-interaction-check.js 51/51 PASS. Pie-Wrapper/-Titel bewusst noch nicht auf FW_CHROME_WRAPPER/TITLE_CLASS migriert (kein Regressionsrisiko, optionale Restarbeit fuer CE-6). Ergebnisprotokolle: docs/steering/patches/AP-chart-engine-01_CE-5_preflight_donut-pie-chrome-vertragskarte_Ergebnis.md, ..._DOC-03_*, ..._CE-5_donut-pie-chrome_segment-daempfung_Ergebnis.md, ..._CE-5a_*, ..._CE-5b_*, ..._CE-5c_*, ..._DOC-04_*, ..._DOC-04a_*, ..._CE-5d_*. Naechster Schritt: CE-6 Cross-Type-Abschluss (Prompt liegt vor, kein automatischer Start); CE-5-Preflight bis CE-5d + DOC-02 bis DOC-04a noch nicht committed.
> AP-chart-engine-01 CE-6/CE-6a ✅ 2026-07-15 — Cross-Type-Abschluss und Engine-DOM-Übergabe, letzter Strang des gestaffelten Engine-DOM-Chrome-Programms (CE-1–CE-6a vollständig abgeschlossen). CE-6 (read-only, Risikoklasse A): Cross-Type-Nachweis über Line/regulären+Ranking-Bar/Donut-Pie — gemeinsame FW_CHROME_LEGEND_PILL_CLASS/_DOT_CLASS-Basis für alle drei aktiven Typen bestätigt, Ranking-Bar strukturell ohne erfundene Legende (interactiveFilters:false -> _renderLegend() liefert null), Pie-Ghost-Zustand per :not(.hidden-dataset) explizit vor dem gemeinsamen Hover-Selektor geschuetzt, DOM-/Canvas-/Plugin-Grenzen sowie beide Engine-Datenpfade (renderFromData()/_processContainer()) unberuehrt, git diff --check + node --check auf allen sieben relevanten Dateien exit 0. Status nach CE-6 zunaechst GELB (statisch bestanden, manuelle Abnahme offen). CE-6a: quittiert Alberts reale S/M/L-Browser-Rueckmeldung (Alles ok.) als bestandene manuelle Abnahme -> Status GRUEN. Vier bewusst offene, nicht blockierende Restpunkte dokumentiert (KDR-15-Chrome-Auftrag technisch noch nicht durchgeleitet — Zielvertrag, eigener kuenftiger Code-AP; F-06 Pie-Drill-down-Popover an document.body unbewertet; Pie-Wrapper/-Titel-Vollmigration auf FW_CHROME_WRAPPER/TITLE_CLASS zurueckgestellt; Donut-Kategorienliste als abweichende Legendenbedeutung offen). Ergebnisprotokoll: docs/steering/patches/AP-chart-engine-01_CE-6_cross-type-abschluss-und-engine-dom-uebergabe_Ergebnis.md. Naechster Schritt: kein Ketten-Nachfolger — naechster Fokus nach Alberts Wahl aus BACKLOG.md; CE-1 bis CE-5d (inkl. DOC-01 bis DOC-04a) bereits committed (20bb90c, 9dd899d, 76d7080, 6470c71, 519584c, 93c884f), nur CE-6/CE-6a noch nicht committed.
> GHOST-05–09 ✅ 2026-07-21 — Ghost-Feed-Dateinamenvertrag (SEC-04) formalisiert, korrigiert, umgesetzt: AppDataResolver.js/JSONParser.js/FinanzwesirJsonData.js neu unter Theme/assets/js/fw-chart-engine/data/ (Geschwister zu CSVParser.js/FinanzwesirData.js), prokrastinations-preis auf Resolver/JSONParser migriert (stations.de.json -> stations-de.json), tools/check-test-pages.py auf den neuen Vertrag synchronisiert (nur noch data-csv als lokale Testreferenz). Ergebnisprotokoll: docs/steering/patches/GHOST-APP-MIGRATION_ENTSCHEIDUNGEN-FORMALISIERUNG_ERGEBNIS.md. Chronik: Archiv/Chroniken/chronist-v1/CHRONIK-2026-07-21-ghost-feed-resolver-vertrag.md. Naechster Schritt: Albert validiert und uebertraegt stations-de.json nach content/files/app-data/; App-seitiges AppContext-Error-(d)-UI/Reduced-Motion (Screen 4) bleibt browserseitig nachzuweisen.
