...
Haiku führt Glob über `.Codex/skills/**/*.md` aus.
...
**Stufe 3:** GitHub-Suche `topic:Codex-skills`
...
Bösartiger Skill kann `.Codex/`-System beschädigen.
...
**Direkt kompatibel:**
`.Codex/skills/[name]/SKILL.md` anlegen.
...
3. Bestätigung ausgeben: „[Name] installiert unter `.Codex/skills/[name]/`. Test: /[name]"
