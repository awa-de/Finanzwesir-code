...
Codex darf vorschlagen wenn Albert Archivwürdigkeit erwähnt hat oder eindeutig Rohmaterial bzw. Belegmaterial entstanden ist. Kein automatischer Vorschlag bei AP-Ende oder Session-Ende.
...
- Codex-Quittungen, Patch-Quittungen, Gate-Reports
- Commit-Messages
...
Codex präsentiert pro Material-Block:
...
Wenn Codex Belegnotizen oder README-Ergänzungen schreibt: vorgeschlagenen Inhalt zeigen. Erst nach OK schreiben.
...
Codex meldet den Aufruf sichtbar vor dem Start:
