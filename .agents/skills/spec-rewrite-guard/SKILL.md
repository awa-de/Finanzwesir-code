...
Trigger: Codex startet automatisch bei Änderungen an `docs/spec/`-Dateien.
...
- Widerspruch zu `AGENTS.md` oder `NAVIGATION.md`?

**4. Auf Alberts OK warten**
Codex schreibt die Änderung erst nach Alberts expliziter Freigabe.
...
- mögliche Widerspruchskandidaten zu AGENTS.md, NAVIGATION.md, docs/spec/
