---
Angelegt am: 25.04.2026 13:21:36
zuletzt verändert am: 2026-04-28T12:27:07+02:00
title: Dashboard Regulatorik — Master-Datei Änderungen
...
**Kontext:** Das Dashboard ist ein interaktiver Renditeverlust-Rechner (Spar- + Entnahmephase), eingebettet in einen Ghost.io-Artikel. Der Artikel liefert den Erklärungskontext. Das Dashboard ist **Werkzeug, kein Essay**. Diese Grundregel ist der Maßstab für alle Entscheidungen unten.
...
### M-1 · KPI-Hierarchie: Primäre Hero-Zahl, sekundäre Karten

**Konsens:** Alle 4 LLMs
**Aufwand:** mittel (Layout-Umbau, kein JS)

**Problem:** Sparphase hat 4 Karten, Entnahmephase hat 3. Alle sehen identisch aus: gleiche Größe, gleiche Typografie, gleicher Rahmen. Die zentrale Aussage — *„Du verlierst X € / Monat"* — verschwindet in der Masse. FAANG-Dashboards (Stripe, Vercel, Linear) haben immer eine dominante Hero-Metrik.

**Fix Sparphase:**
- Groß (Hero): Endvermögen mit vs. ohne Regulatorik
- Klein (sekundär): Verlust in €, Verlust in %
- Sekundär (nicht optional): Nötige Sparrate zum Ausgleich — dieser Wert beantwortet eine Frage, die kein anderes Tool stellt. Als sekundäre, nicht optionale Information behandeln.

**Fix Entnahmephase:**
- Groß (Hero): Jährliche Auszahlung (mit vs. ohne)
- Klein: Differenz pro Monat
- Die „Was dich das kostet"-Tabelle kann hinter einem `„Mehr anzeigen ▾"` accordion verschwinden

**Referenz:** Die Konsequenz-Box in der Gesamtschau macht es bereits richtig — `clamp(2rem, 5vw, 3rem)` für die Headline-Zahl. Dieses Prinzip auf die KPI-Sektionen übertragen.
...
### A-1 · Hero-Zahl oben (feste Schockzahl wie „–1.240 € / Monat")

**Vorgeschlagen von:** ChatGPT (initial), Gemini (initial)
**Abgelehnt:** Korrekt verworfen
...
**OE-1 · Schockzahl vs. relative Metrik als primäre KPI**
Die KPI-Hierarchie (M-1) braucht eine Entscheidung: Was ist die Hero-Zahl der Sparphase — der absolute Verlust in € oder der prozentuale Verlust des Endvermögens? ChatGPT und Gemini haben nach dem Anchoring-Einwand argumentiert, dass relative Metriken (%) robuster sind gegen individuelle Abweichungen. Absolute Zahlen nach Interaktion können dann groß gezeigt werden.
...
11. `[ ]` M-1 — KPI-Hierarchie umbauen (Sparphase + Entnahmephase)
...
19. `[ ]` Offene Entscheidungen (OE-1 bis OE-3) klären und umsetzen

---

*Angelegt: 2026-04-25 | Grundlage: 4 LLM-Feedbacks + technisches Claude-Review des ChatGPT-Umbauvorschlags*
