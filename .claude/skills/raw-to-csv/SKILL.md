---
name: raw-to-csv
description: Rohdatei (XLS/XLSX/CSV) in eine CSVParser-kompatible CSV umwandeln. Albert nennt Dateiname und Pfad in der Konversation, Claude liest den Dataset Contract und ruft tools/raw-to-csv.py auf.
---
