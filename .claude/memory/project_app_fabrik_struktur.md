...
description: "docs/App-Fabrik Steuerungsverzeichnis; 22+3=25 App-Ordner; B1 APP_SPEC V2.0 operativ (Stationen-Zeitreise); Slice-6 ✅ 2026-06-16; B1-AP-01/02 ✅ (ENTSCHEIDUNGSPROTOKOLL + Spec-Umbau); B1-AP-03 nächster Schritt (Datenvertrag Stations-JSON)"
metadata: 
  node_type: memory
  type: project
