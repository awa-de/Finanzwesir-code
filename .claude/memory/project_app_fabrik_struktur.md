...
description: "docs/App-Fabrik Steuerungsverzeichnis; 22+3=25 App-Ordner; B1 APP_SPEC V2.2 operativ (Stationen-Zeitreise); Slice-6 ✅ 2026-06-16; B1-AP-01/02/03/04/05 ✅ (ENTSCHEIDUNGSPROTOKOLL + Spec-Umbau + STATIONS_CONFIG_CONTRACT + UX/Heldenreise §23 + A11y/Mobile §14); B1-AP-06 nächster Schritt (Testfälle)"
metadata: 
  node_type: memory
  type: project
