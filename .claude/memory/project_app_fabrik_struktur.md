...
description: "docs/App-Fabrik Steuerungsverzeichnis; 22+3=25 App-Ordner; B1 APP_SPEC V2.0 operativ (Stationen-Zeitreise); Slice-6 ✅ 2026-06-16; B1-AP-01/02/03 ✅ (ENTSCHEIDUNGSPROTOKOLL + Spec-Umbau + STATIONS_CONFIG_CONTRACT.md); B1-AP-04 nächster Schritt (UX/Heldenreise-Abschnitt)"
metadata: 
  node_type: memory
  type: project
