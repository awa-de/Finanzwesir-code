...
description: "docs/App-Fabrik Steuerungsverzeichnis; 22+3=25 App-Ordner; B1 APP_SPEC V2.9 operativ (Stationen-Zeitreise); B1-AP-01 bis B1-AP-14e11 ✅ 2026-06-22; nächster Schritt B1-AP-15 — Transitions + Reduced Motion"
metadata: 
  node_type: memory
  type: project
...
**B1-AP-14e-Kette ✅ 2026-06-22 (Plugin-Refactoring):** AP-14e1–14e11 abgeschlossen. Plugin-Architektur vollständig: 4 Plugins unter plugins/ (CenterText, Crosshair, FwAnnotationPulse, FwVerticalLine), kanonischer Barrel plugins/index.js, FwChartPlugins-Shim + FwBarLayoutPlugin entfernt, 0 Importzyklen. Spec nachgeschärft: CHART_PLUGIN_ARCHITEKTUR.md §3+§20.3 (AP-14e10b). QA-FREIGABE: AP-14e11. Nächster Schritt: **B1-AP-15 — Transitions + Reduced Motion.**
