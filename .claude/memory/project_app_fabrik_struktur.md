...
description: "docs/App-Fabrik Steuerungsverzeichnis; 22+3=25 App-Ordner; B1 APP_SPEC V2.3 operativ (Stationen-Zeitreise); Slice-6 ✅ 2026-06-16; B1-AP-01 bis AP-06 ✅ (ENTSCHEIDUNGSPROTOKOLL + Spec-Umbau + STATIONS_CONFIG_CONTRACT + UX/Heldenreise §23 + A11y/Mobile §14 + QA_TEST_CASES.md); B1-AP-07 nächster Schritt (Redaktions-Gate)"
metadata: 
  node_type: memory
  type: project
