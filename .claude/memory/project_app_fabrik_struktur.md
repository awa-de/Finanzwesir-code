...
description: "docs/App-Fabrik Steuerungsverzeichnis; 22+3=25 App-Ordner; B1 APP_SPEC V2.9 operativ (Stationen-Zeitreise); B1-AP-01 bis B1-AP-14e12 ✅ 2026-06-22; nächster Schritt B1-AP-15 — Transitions + Reduced Motion"
metadata: 
  node_type: memory
  type: project
...
**B1-AP-14e-Kette ✅ 2026-06-22 (Plugin-Refactoring + Doku):** AP-14e1–14e12 abgeschlossen. Plugin-Architektur vollständig: 4 Plugins unter plugins/ (CenterText, Crosshair, FwAnnotationPulse, FwVerticalLine), kanonischer Barrel plugins/index.js, FwChartPlugins-Shim + FwBarLayoutPlugin entfernt, 0 Importzyklen. Spec nachgeschärft: CHART_PLUGIN_ARCHITEKTUR.md §3+§20.3 (AP-14e10b), §4+§18+§20.3+§20.6+§20.8 (AP-14e12). X-Achsen-Docs I/II/III als historische Designintention markiert (AP-14e12). QA-FREIGABE: AP-14e11. Spec-Drift-FREIGABE: AP-14e12. Nächster Schritt: **B1-AP-15 — Transitions + Reduced Motion.**
