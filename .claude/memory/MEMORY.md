...
- [prokrastinations-preis: Drehbuch vs. APP_SPEC](project_prokrastinations_preis_drehbuch.md) — Screen 4 seit AP-prokrast-04a in APP_SPEC §16.1a synchronisiert; QA_TEST_CASES.md seit AP-prokrast-05a-05e synchron inkl. CTA-Fokus (AP-27 erledigt); offen: Beat-2-Symbolik (BACKLOG AP-26), Card-to-Point
