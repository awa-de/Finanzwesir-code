...
- [ChartEngine AnchorMeasurement/ChartSettled/RenderMotion](project_chartengine_anchormeasurement_contracts.md) — 3 additive Render-Contracts seit AP-08b; chartSettled Creation-Pfad seit AP-09b geschlossen; No-op-Bootstrap bleibt offene Spec-Konflikt-Entscheidung (§4 CHART_PLUGIN_ARCHITEKTUR.md)
