...
- [CI-/Theme-Bridge Status](project_ci_theme_bridge.md) — Engine/Theme-Seite (1357b46), Spec (kdr14, 21e87a2), app.css-Pilot (AP-17, 6ea9704), QA-Kettenreview (17b–19, 8a4163a), fwCiAudit()-Tool (ab95cfd) committed; Font-Bridge umgesetzt (AP-17-FONT-CODE-A/B, uncommitted). TESTENV-1-Initiative durch TESTENV-1g vollständig abgeschlossen (BTNFONT+H3LEAK behoben, uncommitted); BORDER bleibt offen (Tailwind). Offen: App-Pool-Rollout, Rubikon-Nachmessung (DS-FOLLOWUP-07, fällig), Spacing/Ghost-Anbindung (T1)
