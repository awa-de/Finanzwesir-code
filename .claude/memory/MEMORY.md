...
- [prokrastinations-preis: Drehbuch vs. APP_SPEC](project_prokrastinations_preis_drehbuch.md) — Screen 4 seit AP-prokrast-04a in APP_SPEC §16.1a synchronisiert; QA seit 05a-05e synchron; ✅/❓-Symbolik seit 06a-06d entschieden, seit 07a-07d fertig gebaut + GRÜN; Screen-2 Card-to-Point seit 08a-08c gebaut (GELB); offen: DS-FOLLOWUP-07/08, AP-prokrast-08-FOLLOWUP-A/B, Screen-3-Timing
- [ChartEngine AnchorMeasurement/ChartSettled/RenderMotion](project_chartengine_anchormeasurement_contracts.md) — 3 neue additive Render-Contracts seit AP-prokrast-08b; Chart.js registriert Plugins nur bei new Chart(), nie im Smart-Update-Pfad (No-op-Bootstrap-Workaround); chartSettled Creation-Pfad-Lücke offen
