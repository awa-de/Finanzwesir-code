...
- [Abschluss-Ritual: append-only + Snapshot-Modell](project_ritual_token_optimization.md) — RITUAL-OPT-1+2 komplett: NAVIGATION/BACKLOG jetzt auch read-frei (replace-matched-line/append-block), Hook übernimmt BACKLOG-Extraktion, BACKLOG-ARCHIV datumsbasiert rotiert, PS5.1-Emoji-Fallstrick
