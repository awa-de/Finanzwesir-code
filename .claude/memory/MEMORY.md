...
- [Chart-Chrome-Migration (CE-1–CE-6a)](project_chartengine_chrome_migration.md) — Kette VOLLSTÄNDIG ABGESCHLOSSEN 2026-07-15, committed (2757580); FW_CHROME_*-Musterpflicht; Pie-Segment-Dämpfung als 4. Legend-Bedeutung (DOC-03), DOC-04-Präzedenzfall, CE-6-Lehre: Albert kann Prompt-Hard-Stops gezielt übersteuern
...
- [Scope-Auftragstreue](feedback_scope_auftragstreue.md) — nicht mehr/anders tun als beauftragt; bei Abweichung/Nebenwirkung proaktiv im Ergebnisprotokoll nennen statt still zu fixen
