...
- [CI-/Theme-Bridge Status](project_ci_theme_bridge.md) — Engine/Theme-Seite (1357b46), Spec (kdr14, 21e87a2), app.css-Pilot (AP-17, 6ea9704), QA-Kettenreview (17b–19, 8a4163a), fwCiAudit()-Tool (ab95cfd) committed; Font-Bridge umgesetzt (AP-17-FONT-CODE-A/B, uncommitted); TESTENV-1 vollständig abgeschlossen. NEU 2026-07-12: Tailwind-App-Baukasten V0.1 (AP-tailwind-01-Befund → Fable-Runde) als verbindlicher Design-Vertrag freigegeben, TAILWIND-APP-BAUKASTEN_KONZEPT_V0-1.md; NEU 2026-07-13: Play-CDN-Vertrag entschieden+gehärtet (02a/02b), Slice 1+2 (Shell/States+KPI) umgesetzt+abgenommen (02c/02d/02e); nächster Schritt AP-tailwind-02 Slice 3
