...
- [CI-/Theme-Bridge Status](project_ci_theme_bridge.md) — Engine/Theme-Seite (1357b46), Spec (kdr14, 21e87a2), app.css-Pilot (AP-17, 6ea9704) committed; QA-Doku+Kettenreview (17b–19) + Font-Anamnese+Spec-Parität abgeschlossen (uncommitted) — Font-Bruchstelle = Namens-Mismatch, Spec auf KDR-14-Font-Parität gehoben, Code offen. Weiter offen: CI-Fonts ungebridged (Code), Spacing/Ghost-Anbindung (T1), Harness-Versionierung (TESTENV-1)
