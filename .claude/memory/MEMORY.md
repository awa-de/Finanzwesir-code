...
- [Abschluss-Ritual: append-only + Snapshot-Modell](project_ritual_token_optimization.md) — Snapshot klein (PROJECT-STATUS, Größen-Riegel) vs. append-only-Log read-frei (Archiv/session-log/DECISION-LOG); Tools check-project-status-hook-meta/append-log-line/rotate-log; Phantomfeld-Nebenabschluss-Lehre
