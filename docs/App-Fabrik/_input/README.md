# _input — Externe Vorschläge und Input-Material

Dieses Verzeichnis enthält externe Vorschläge, die als ernsthafte Unterstützung geprüft wurden, aber nicht 1:1 als Produktionsstandard übernommen werden.

**Einordnung:** Input, nicht bindend.
