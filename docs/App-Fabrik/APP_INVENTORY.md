...
| `prokrastinations-preis` | B1 Marktzeit schlägt Timing | Master-App | vollständig eigenständig | Scenario Chart (historische Monatsdaten) | Historische MSCI-World-Monatsdaten (CSV; Dataset siehe APP_SPEC §7) | Mittel — historische Linie + Entscheidungspunkt | MSCI-Datenbasis, Startpunkt = heute − 120 Monate |
