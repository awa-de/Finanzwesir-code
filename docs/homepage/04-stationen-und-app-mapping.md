# Stationen und App-Mapping

## Zweck dieser Datei

Diese Datei ordnet jeder Station der Homepage eine psychologische Blockade, eine App, eine Erkenntnis und einen nächsten Schritt zu.

Sie dient als Brücke zwischen Konzept, Text und späterer statischer HTML-Seite.
