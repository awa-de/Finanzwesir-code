...
| AP-tailwind-02 | Design | Pilotmigration `prokrastinations-preis` auf Tailwind-Baukasten: echte Utility-Einführung nach Konzept §9 (Migrationskarte), `--fw-space-*` ersatzlos ablösen (D-08, Abnahme: Grep leer), Literalregel §2.2, App-Mechanik unangetastet. Slice 0 = Tailwind-Laufzeitfrage im Test-/Ghost-Kontext mit Albert klären (TEST_PAGE_STANDARD §10 CDN-Verbot vs. Play-CDN-Arbeitsannahme) | H | Baukasten ✅ | docs/steering/handovers/SONNET-PROMPT_AP-tailwind-02_pilotmigration_V1.md |
