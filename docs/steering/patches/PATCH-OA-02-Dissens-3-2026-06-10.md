PATCH-QUITTUNG | AP OA-02-Dissens-3 | 2026-06-10
Beauftragt:    Markup-Vertrag für In-App-Charts schärfen: separater
               fw-appchart-Marker, Container-Guard-Pflicht, D-OA-02-3
Geändert:      3 Datei(en), 6 Stelle(n)
Dateien:       docs/spec/APP-INTERFACE.md
...
Testfall:      Dokumentenreview — kein Browser-Test (reine Doku-Änderung).
               (1) §3.2 APP-INTERFACE.md unverändert?
               (2) Neuer Unterabschnitt §4 konsistent mit
